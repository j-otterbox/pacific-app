...
class ProjectForm:
    def __init__(self):
        ...
        self._manager_form.set_back_btn_callback(self._return_to_project_form)
    ...
    def _return_to_project_form(self) -> None:
        """ Callback for back button of the Manager Form. """
    ...
    def render(self) -> None:
        ...
        dpg.push_container_stack(modal_tag)
